...
# dt_raw <- run_sim(params = params, dt_incubation_dists_lnorm = dt_incubation_dists_lnorm)
# fwrite(dt_raw, file = "../quarantineApp/dt_raw.csv")
...
#t1 <- theme_box(t1)
t1 <- theme_zebra(t1)
t1 <- fontsize(t1, size = 9, part = "all")
...
# Extended methods: calculation of days at risk based on quarantine duration and testing
